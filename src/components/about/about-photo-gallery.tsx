    ...
    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-6">
      {communityPhotos.map((photo, index) => (
        <figure
          key={photo.src}
          className={cn(
            "group overflow-hidden rounded-2xl border border-border/50 bg-card/40 shadow-sm ring-1 ring-black/[0.03] transition-all duration-300 hover:-translate-y-0.5 hover:border-brand/20 hover:shadow-md",
